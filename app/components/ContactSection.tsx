		...
		<section className="py-20 px-4">
			<div className="max-w-4xl mx-auto text-center">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
					<h2 className="text-3xl font-bold">Let&apos;s Build Intelligent Systems Together</h2>
					<p className="text-gray-400 max-w-2xl mx-auto">
						Looking for an engineer who can architect scalable backends, design data pipelines, and integrate AI into real-world products? Let&apos;s talk about how I can help bring your vision to production.
					</p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <path fillRule="evenodd" d="M8 11a1 1 0 011-1h2a1 1 0 110 2h-2a1 1 0 01-1-1z" clipRule="evenodd" />
              </svg>
              View Resume
            </a>
          </div>
